...
- **d-test family coverage: 13 impls on main + 2 doctrinal reservations per ADR-0049, 15-sister ID space total** (impls: d046a/d046b/d046c/d048/d050b/d051/d052/d053/d054/d058/d059/d060/d061; doctrinal reservations: d055, d056, NO impls as of Sprint 15 close, deferred to Sprint 17+ workshop decision; scripts/tests/INDEX.md live, + d031 retired stub). **PM authoring correction (Issue #535, RETRO-007 §11):** Original line listed 16 entries including d046 umbrella (no impl, replaced by d046a/b/c per Issue #539 Sprint 15 P2 #10 rename) + d055/d056 doctrinal reservations as siblings — internally inconsistent (counted impls + reservations + deprecated umbrella as siblings). Corrected to 13 impls + 2 reservations.
...
4. **d-test family coverage: 13 impls on main + 2 doctrinal reservations per ADR-0049, 15-sister ID space total** (Sprint 14 8-sister impls + Sprint 15 +3 d-tests [d059/d060/d061] + d046×3 rename [+2 net: d046 umbrella → d046a/b/c] = 13 impls; d055 + d056 = doctrinal reservations, no impls). **PM authoring correction (Issue #535, RETRO-007 §11, applied 2026-06-28):** Original line claimed "expansion from 10 to 16 files (counting d046a/b/c split), 13 distinct IDs" — math inconsistent (10 + 3 + 2 = 15, not 13). Corrected math: 8 (Sprint 14 impls, excluding d046 umbrella) + 3 (Sprint 15 d059/d060/d061) + 2 (d046 split net: 1 → 3 = +2) = 13 impls. d055/d056 doctrinal reservations per ADR-0049 are NOT impls.
