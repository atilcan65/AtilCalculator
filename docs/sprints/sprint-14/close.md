...
- **d-test family coverage: 10-sister ID space, 8 impls + 2 doctrinal reservations** (d046/d048/d050b/d051/d052/d053/d054/d058 = 8 impls on main; d055 + d056 = doctrinal reservations per ADR-0049, NO impls as of Sprint 14 close, deferred to Sprint 16+ workshop decision; lint-and-test.yml + scripts/tests/INDEX.md via PR #511). **PM authoring correction (Issue #535, RETRO-007 §11):** Sprint 14 originally claimed "10-sister on main + d058 in CI" with d055/d056 listed as siblings — but PR #503 (ADR-0054 §9-Lens enforcement, doctrine-only) and PR #502 (ADR-0053 Layer 5 race codification, doctrine-only) did NOT ship d-test impls. Only PR #506 (d058) added a new impl.
...
3. **d-test family coverage: 10-sister ID space, 8 impls + 2 doctrinal reservations** (post-Sprint 14): Sprint 14 shipped 1 new impl (d058 via PR #506 wip_overflow home), going from 7-sister → 8-sister impl count. d055 + d056 are doctrinal reservations per ADR-0049 (NOT Sprint 14 deliverables — impls deferred to Sprint 16+ workshop decision). d-test family ID space remains 10-sister (d046/d048/d050b/d051/d052/d053/d054/d058 + d055/d056 reservations). **PM authoring correction (Issue #535, RETRO-007 §11, applied 2026-06-28):** Original Sprint 14 close.md text claimed "Sprint 14 shipped d055 (PR #503 codifier) + d056 (PR #502 codifier) + d058" — false, PR #503 = ADR-0054 §9-Lens enforcement ADR (doctrine-only), PR #502 = ADR-0053 Layer 5 race ADR (doctrine-only). d-test impl count delta = +1 (d058 only), not +3.
