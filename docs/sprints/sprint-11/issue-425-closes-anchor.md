...
## d-test attestation (Issue #425 AC2.1 + sister-cascade)

- **d048-adr-0012-status-ready-gating.sh** current state: **10/10 PASS (T1-T7)** on pr-445-head
- **Issue #425 original AC2.1 contract (4/4 PASS on current main @ 2854f41)**:
...
- **Sister-cascade additions (post-#438 regression saga, regression anchors, NOT in original AC2.1)**:
