...
**Supersedes:** —
**Related:** [`.claude/CLAUDE.md` §Autonomy Loop](../../.claude/CLAUDE.md) (human-mirror, owner-only), [ADR-0010](./ADR-0010-per-project-watchers.md) (Per-Project Systemd Watchers), [ADR-0012](./ADR-0012-required-label-set.md) (Required Label Set), [ADR-0013](./ADR-0013-status-label-to-board-sync.md) (Status → Board Sync), [ADR-0015](./ADR-0015-atomic-agent-handoff.md) (Atomic Hand-off), [ADR-0020](./ADR-0020-label-mutation-transactionality.md) (Label-Mutation Transactionality), [ADR-0021](./ADR-0021-docs-pr-convention.md) (Docs PR Convention), [ADR-0024](./ADR-0024-stale-verdict-watchdog-schema.md) (Stale-Verdict Watchdog), [ADR-0025](./ADR-0025-bound-standby-exception.md) (Bound Standby Exception), [ADR-0026](./ADR-0026-queue-empty-mention-check.md) (Queue-Empty Wake), [TD-011](../tech-debt.md) (PM watcher gap), [Issue #46](https://github.com/atilcan65/AtilCalculator/issues/46) (P0 chore, stale-verdict), [Issue #109](https://github.com/atilcan65/AtilCalculator/issues/109) (bound standby), [Issue #113](https://github.com/atilcan65/AtilCalculator/issues/113) (issue assigneeship authority), [Issue #203](https://github.com/atilcan65/AtilCalculator/issues/203) (this ADR's filing issue), `scripts/agent-watch.sh`
...
- **Human-mirror version**: [`.claude/CLAUDE.md` §Autonomy Loop](../../.claude/CLAUDE.md) (owner-only file; canonical content mirrored here for agent readability).
