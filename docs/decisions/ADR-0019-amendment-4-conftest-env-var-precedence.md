...
**Related:** [Issue #728](https://github.com/atilproject/AtilCalculator/issues/728) (Sprint 22 PIVOT engine-perf RCA); [PR #729](https://github.com/atilproject/AtilCalculator/pull/729) (dev fixup `|| 2.0` fallback); [PR #731](https://github.com/atilproject/AtilCalculator/pull/731) (lazy-import mpmath impl); [PR #732](https://github.com/atilproject/AtilCalculator/pull/732) (amendment 3 doctrine codification); [PR #734](https://github.com/atilproject/AtilCalculator/pull/734) (dev impl — conftest helper + d112 d-test, MERGED 2026-06-30T20:13:46Z @ 727a2c70a273); [PR #726](https://github.com/atilproject/AtilCalculator/pull/726) (engine-perf canonical PR — was chicken-egg blocked); [PR #679](https://github.com/atilproject/AtilCalculator/pull/679) (d069 d-test carrier); [PR #694](https://github.com/atilproject/AtilCalculator/pull/694) (TD-044 cascade); [PR #730](https://github.com/atilproject/AtilCalculator/pull/730) (TD-044 docs filing); [Issue #706](https://github.com/atilproject/AtilCalculator/issues/706) (post-merge RCA — sprint plan doc); [TD-046-extension](./../tech-debt.md) (new entry — dual-source-of-truth blind-spot, ~12th in 9-Lens family); [Issue #113](https://github.com/atilproject/AtilCalculator/issues/113) (label-authority > body doctrine — labels are source of truth)
...
- **Sprint 22 PIVOT engine-perf RCA**: [Issue #728](https://github.com/atilproject/AtilCalculator/issues/728) (origin of amendment 3 + this amendment)
- **PR #734 (impl)**: [PR #734](https://github.com/atilproject/AtilCalculator/pull/734) (MERGED 2026-06-30T20:13:46Z @ 727a2c70a273 — conftest resolver + d112 d-test)
- **PR #732 (amendment 3 doctrine)**: [PR #732](https://github.com/atilproject/AtilCalculator/pull/732) (owner squash pending — env var = single source of truth doctrine)
- **PR #731 (lazy-import impl)**: [PR #731](https://github.com/atilproject/AtilCalculator/pull/731) (arch sign-off + PM validation, owner squash pending)
- **PR #729 (env var lookup)**: [PR #729](https://github.com/atilproject/AtilCalculator/pull/729) (dev fixup `|| 2.0` fallback, owner squash pending)
- **PR #730 (TD-044 cascade)**: [PR #730](https://github.com/atilproject/AtilCalculator/pull/730) (docs(tech-debt) filing, owner squash pending)
- **PR #726 (engine-perf canonical)**: [PR #726](https://github.com/atilproject/AtilCalculator/pull/726) (canonical perf PR — was chicken-egg blocked, now unblocked post-#734)
- **PR #679 (d069 d-test carrier)**: [PR #679](https://github.com/atilproject/AtilCalculator/pull/679) (tester-authored, RETRO-016 #2/#3 LIVE INSTANCE)
- **PR #694 (TD-044 cluster)**: [PR #694](https://github.com/atilproject/AtilCalculator/pull/694) (tester-authored followup)
...
- **Label-authority doctrine**: [Issue #113](https://github.com/atilproject/AtilCalculator/issues/113) (labels > body; PR #734 squash gate via `verdict-by:<ts>` labels)
