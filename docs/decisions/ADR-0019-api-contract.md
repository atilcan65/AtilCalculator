...
- **Related**: [ADR-0017](./ADR-0017-tech-stack.md) (Accepted — engine ↔ UI separation, FastAPI HTTP surface); [ADR-0018](./ADR-0018-front-end-framework.md) (Accepted — vanilla JS + Web Components client); [Issue #27 BUG + PR #28 fix](https://github.com/atilcan65/AtilCalculator/issues/27) (CI integrity lesson → §Observability); [STORY-002 PR #23](https://github.com/atilcan65/AtilCalculator/pull/23) (engine exception hierarchy input); [STORY-003a Issue #30](https://github.com/atilcan65/AtilCalculator/issues/30) (depends on this ADR for `POST /api/evaluate` contract); [ADR-0019 amendment 2](./ADR-0019-amendment-2-decimal-and-envelope.md) (PR #84, 2026-06-18 — mpmath + 170! + DomainError + envelope)
- **Supersedes**: —
