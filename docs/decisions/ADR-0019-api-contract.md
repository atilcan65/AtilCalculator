...
- **Status**: Accepted (via PR #33, 2026-06-17; amended via PR #63 on 2026-06-18 §Decimal trailing-zero + §Exception taxonomy; amended via [PR #84](./ADR-0019-amendment-2-decimal-and-envelope.md) on 2026-06-18 §mpmath transcendentals + §factorial cap + §DomainError + §GET /api/history envelope)
- **Date**: 2026-06-17
...
- **Related**: [ADR-0017](./ADR-0017-tech-stack.md) (Accepted — engine ↔ UI separation, FastAPI HTTP surface); [ADR-0018](./ADR-0018-front-end-framework.md) (Accepted — vanilla JS + Web Components client); [Issue #27 BUG + PR #28 fix](https://github.com/atilproject/AtilCalculator/issues/27) (CI integrity lesson → §Observability); [STORY-002 PR #23](https://github.com/atilproject/AtilCalculator/pull/23) (engine exception hierarchy input); [STORY-003a Issue #30](https://github.com/atilproject/AtilCalculator/issues/30) (depends on this ADR for `POST /api/evaluate` contract); [ADR-0019 amendment 2](./ADR-0019-amendment-2-decimal-and-envelope.md) (PR #84, 2026-06-18 — mpmath + 170! + DomainError + envelope)
- **Supersedes**: —
