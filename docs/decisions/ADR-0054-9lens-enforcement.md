...
- [ADR-0052 CI re-run race codification](./ADR-0052-ci-rerun-race-codification.md) (d056 sister-pattern)
- [ADR-0053 Layer 5 race pattern](./ADR-0053-layer-5-race-pattern.md) (sister-pattern, this PR's birth family)
