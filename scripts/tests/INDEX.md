...
| **d059** | d-test family persistence (variant (a) chain dep pollution companion) | `scripts/tests/d059-dtest-family-persistence.sh` | 9/9 (TC1 ID↔file, TC2 naming, TC3/TC4 dogfooding, **TC5 d046×3 REMEDIATED via PR #541 (d046→d046a/b/c); d031×2 still acknowledged as historical drift (Issue #537 AC1 follow-up)**, TC6 INDEX parse, TC7 broken-fixture contract, TC8 ≥10 sister count, TC9 cadence Rule 1 INDEX entry) | d058/d060 sister-pattern (--self-test flag, fake-binary factory) | RETRO-009 §6, Issue #523 (STORY-022), Issue #539 AC1+AC3 (PR #541), Issue #539 AC2 (strict invariant follow-up after Issue #537 AC1), Issue #537 (d031×2 remediation), ADR-0044 + ADR-0049 | NOT yet CI-integrated |
