...
| **d057** | sync-status workflow retry + silent-skip guard | `scripts/tests/d057-sync-status-retry.sh` | 9/9 (TC1 YAML baseline, TC2 withRetry, TC3 silentSkip, TC4 wrapped graphql, TC5 concurrency, TC6 core.warning, TC7 try-catch, TC8 throw err, TC9 per-PR group) | d054 (deep-narrow) + d055 (Layer 5 idempotency reconcile) + d056 (regression guard) sister-pattern | ADR-0056 §Layer 5 idempotency reconcile (silent-skip sister-pattern), ADR-0014 §PROJECT_TOKEN secret doctrine, Issue #571 AC1-AC5, §32 LIVE INSTANCE #8 + #13 (PR #565 + Issue #564 cascade family) | NOT yet CI-integrated |
