...
#   STATE_FILE               override state file path (default: /var/log/dev-studio/AtilCalculator/orchestrator-gap-scan.state)
#
...
STATE_FILE="${STATE_FILE:-/var/log/dev-studio/AtilCalculator/orchestrator-gap-scan.state}"
