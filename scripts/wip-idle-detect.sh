...
#
# Detects agents with `WIP > 0 + no activity 30m` per the doctrine in
# docs/decisions/ADR-0039-wip-idle-watchdog.md. Emits a JSON array of idle
# roles for the orchestrator's wake loop to consume.
#
