#!/usr/bin/env bash
# post-restart-label-guard.sh — Sprint 4 P0 AUTO-REVERT-FIX
# Idempotent label-guard: after atilcalc-web.service restart, re-apply only
# labels in scripts/restart-stable.txt. All other labels are preserved as-is.
#
# Design: docs/designs/STORY-AUTO-REVERT-FIX-design.md (PR #211, merged 2026-06-21T16:35:47Z)
# Story: Sprint 4 P0 AUTO-REVERT-FIX (plan §Committed scope, Issue #209 kickoff)
# Refs:  Issue #125 (RCA closed 2026-06-21T13:36:24Z as restart theory, COMPLETED)
#        RCA-15 (service persistence), RCA-16 (ExecStart fail), RCA-17 (unit-path)
