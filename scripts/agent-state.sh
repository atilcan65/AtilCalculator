...
cmd_set() {
  ...
  # ADR-0034 JSON contract: callers MUST pass JSON-parseable input.
  # --argjson parses the value as JSON; invalid input fails fast (exit 2)
  # instead of silently stringifying arrays/objects (the bug class).
